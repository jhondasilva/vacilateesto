...
const episodes = [
  {
    id: 1,
    title: "Summit Podcast: Naiguatá Ep 1 ⛰️ con JuanSofa y JhonSnacks",
    description: "Conquistamos el Pico Naiguatá y seguimos hasta el pico oriental, occidental, Ávila y Picacho. ¡Los venezolanos somos de altura!",
    views: "Nuevo",
    date: "Agosto 2025",
    videoId: "fsXSN78UODI",
    image: "https://img.youtube.com/vi/fsXSN78UODI/maxresdefault.jpg",
    isNew: true,
  },
  {
    id: 2,
    title: "Venezolario: Conectando Raíces a Través del Juego 🇻🇪",
    description: "Conversamos con Katty Kanzler, la mente brillante detrás de la app que celebra nuestro lenguaje venezolano.",
    views: "10K views",
    date: "Agosto 2025",
    videoId: "kajNxEYYIJ0",
    image: "https://img.youtube.com/vi/kajNxEYYIJ0/maxresdefault.jpg",
    isNew: true,
  },
  {
    id: 3,
    title: "40 años de Desorden Público: Historia, rebeldía y emociones 🎺",
    description: "JuanSofa y JhonSnacks hablan con Desorden Público sobre música, historia, migración y rebeldía.",
    views: "25K views",
    date: "Abril 2025",
    videoId: "09Fldk9zHmk",
    image: "https://img.youtube.com/vi/09Fldk9zHmk/maxresdefault.jpg",
    isNew: false,
  },
  {
    id: 4,
    title: "NORANEKO: El MEJOR RAMEN de VENEZUELA 🍜✨",
    description: "JuanSofa & JhonSnacks prueban el que podría ser el mejor ramen de Venezuela en Vacílate Esto Comiendo.",
    views: "73K views",
    date: "2024",
    videoId: "3LMk_9LwRwM",
