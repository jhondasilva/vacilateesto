...
const RutaRamenSection = () => {
  ...
  return (
    <section className="py-16 md:py-24 bg-background relative overflow-hidden">
      ...
      <div className="absolute -left-20 top-1/4 w-80 h-80 bg-primary/5 rounded-full blur-3xl" />
      <div className="absolute -right-20 bottom-1/4 w-60 h-60 bg-[#7DE8E8]/10 rounded-full blur-3xl" />
