      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-center mb-16">
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative max-w-sm mx-auto">
              {/* Spinning sticker */}
              <div className="absolute -top-6 -left-6 z-30 w-24 h-24 animate-spin-slow">
                ...
                <Sparkles className="absolute inset-0 m-auto w-7 h-7 text-primary" aria-hidden="true" />
              </div>
              ...
              <div className="relative bg-background rounded-3xl border-2 border-foreground p-8 md:p-10 shadow-[12px_12px_0_hsl(var(--accent))] hover:shadow-[16px_16px_0_hsl(var(--primary))] hover:-translate-x-1 hover:-translate-y-1 transition-all -rotate-2 hover:rotate-0">
                <img
              ...
              <div className="absolute -bottom-4 -right-4 z-30 bg-accent text-accent-foreground rounded-2xl px-3 py-2 -rotate-6 hover:rotate-0 transition-transform border-2 border-foreground shadow-[5px_5px_0_hsl(var(--foreground))]">
          ...
          <div className="lg:col-span-7 text-center lg:text-left">
            ...
            <h2 className="font-display font-black text-foreground tracking-[-0.04em] leading-[0.88] text-4xl sm:text-5xl md:text-6xl lg:text-[5.5rem] mb-6">
              la magia
        ...
        <div className="grid grid-cols-3 gap-3 md:gap-6 max-w-3xl mx-auto mb-16">
          {stats.map((stat, index) => (
            <div
              key={index}
              className="relative bg-background border-2 border-foreground rounded-2xl p-4 md:p-6 text-center shadow-[5px_5px_0_hsl(var(--foreground))] hover:shadow-[7px_7px_0_hsl(var(--primary))] hover:-translate-x-0.5 hover:-translate-y-0.5 transition-all"
              style={{ transform: `rotate(${[-1.5, 0.5, -1][index]}deg)` }}
            >
              <div className="font-display font-black text-3xl md:text-5xl text-foreground tracking-tight">
                {stat.value}
              </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-6 mb-16">
          {features.map((feature, index) => {
            ...
            return (
              <article
                key={index}
                className="group relative bg-background rounded-3xl border-2 border-foreground p-6 hover:-translate-y-1 transition-all duration-300"
                style={{
                  boxShadow: isAccent
                    ? "6px 6px 0 hsl(var(--primary))"
                    : "6px 6px 0 hsl(var(--accent))",
                }}
              >
                <div
        ...
        <div className="relative bg-background rounded-3xl border-2 border-foreground p-8 md:p-12 shadow-[10px_10px_0_hsl(var(--foreground))]">
