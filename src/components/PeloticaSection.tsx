...
const PeloticaSection = () => {
  return (
    <section className="py-16 md:py-24 bg-gradient-to-b from-background to-accent/20 relative overflow-hidden">
      {/* Background decoration */}
      <div className="absolute -right-20 top-1/3 w-80 h-80 bg-primary/5 rounded-full blur-3xl" />
      <div className="absolute -left-20 bottom-1/4 w-60 h-60 bg-[#7DE8E8]/10 rounded-full blur-3xl" />
