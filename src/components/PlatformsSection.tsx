const platforms = [
  {
    ...
    link: "https://www.youtube.com/@Vacilateestopodcast",
  ...
  },
  {
    ...
    link: "https://www.instagram.com/vacilateestopodcast/",
  ...
  },
  {
    ...
    link: "https://www.facebook.com/vacilatestopodcast/",
    subscribers: "Comunidad",
  },
  {
    name: "Spotify",
    icon: (
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg max-w-xl mx-auto">
            Disponible en todas las plataformas principales. Elige tu favorita y únete a nuestra comunidad.
          </p>
        </div>
