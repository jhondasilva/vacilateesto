...
import { Download, Trophy, Mail, Newspaper, ArrowLeft, Star } from "lucide-react";
...
const PrensaFIAP2026 = () => {
  const structuredData = {
    "@context": "https://schema.org",
    "@type": "NewsArticle",
    headline: "Vacílate Esto: 5 finalistas en los FIAP 2026",
    datePublished: "2026-08-20",
    inLanguage: "es-VE",
    author: { "@type": "Organization", name: "Vacílate Esto" },
    publisher: { "@type": "Organization", name: "Vacílate Esto" },
    about: "FIAP 2026 · Finalistas · Publicidad Iberoamericana",
  };

  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Nota de prensa: Vacílate Esto, 5 finalistas en FIAP 2026</title>
        <meta
          name="description"
        ...
        />
        <link rel="canonical" href="https://www.vacilateesto.com/prensa/fiap-2026" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Nota de prensa: Vacílate Esto, 5 finalistas en FIAP 2026" />
        <meta
      ...
      <main>
        ...
        <section className="py-14 sm:py-20 bg-foreground text-background border-b-4 border-foreground">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            >
              <ArrowLeft className="w-3.5 h-3.5" /> Premios y reconocimientos
            </Link>
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary text-primary-foreground border-2 border-background rounded-full mb-6 rotate-[-2deg]">
              ...
              <span className="font-display font-black text-xs uppercase tracking-widest">Nota de prensa · Caracas, 20 de agosto de 2026</span>
            </div>
            <h1 className="font-display font-black text-3xl sm:text-5xl md:text-6xl tracking-[-0.04em] leading-[0.92]">
              Vacílate Esto suma{" "}
              <span className="italic text-primary">5 finalistas</span> en los FIAP 2026
            </h1>
            ...
            <div className="flex flex-wrap gap-3 mt-8">
              ...
              >
                <Trophy className="w-4 h-4" /> Press Kit
              </Link>
            </div>
          </div>
        </section>
        ...
        <section className="py-14 sm:py-20 bg-background border-b-4 border-foreground">
          <div className="container mx-auto px-4 max-w-3xl space-y-5 font-body text-foreground/85 leading-relaxed">
            ...
            <p>
              Las nominaciones reconocen el trabajo de tres formatos propios del ecosistema Vacílate Esto: la
              docuserie <strong>Streaming from the Lost World</strong>, la campaña{" "}
              <strong>Walking Ads Above the Algorithm</strong> y el evento en vivo{" "}
              <strong>Pelotica de Goma: The Legacy</strong>. Las categorías abarcan técnicas de producción de contenidos,
              estrategia digital, lanzamiento de programas, promoción de broadcast y eventos en vivo o híbridos.
            </p>
            <p>
              Los FIAP 2026 consolidan a Vacílate Esto como una de las marcas de entretenimiento digital más relevantes
              de Venezuela, hecha en Venezuela, con capacidad de crear formatos propios que compiten a nivel
        ...
        <section className="py-14 sm:py-20 bg-muted/30 border-b-4 border-foreground">
          <div className="container mx-auto px-4 max-w-5xl">
            <StickerHeader
              ...
              title="Las cinco nominaciones"
              highlight="de Vacílate Esto"
              align="center"
            />
        ...
        <section className="py-14 sm:py-20 bg-background border-b-4 border-foreground">
          <div className="container mx-auto px-4 max-w-3xl space-y-5 font-body text-foreground/85 leading-relaxed">
            <h2 className="font-display font-black text-2xl sm:text-3xl tracking-[-0.03em] text-foreground mb-4">
              Sobre los proyectos finalistas
            </h2>
            <p>
              <strong>Streaming from the Lost World</strong> es una docuserie de viajes y exploración que lleva a Juan y
              Jhon a lugares fuera del estudio, convirtiendo cada destino en una excusa para contar historias insólitas
              de Venezuela y el mundo.
            </p>
            <p>
              <strong>Walking Ads Above the Algorithm</strong> es una campaña de contenido que demuestra cómo las
              marcas pueden romper la lógica de los algoritmos mediante piezas creativas, calle y conversación
              auténtica con la comunidad.
            </p>
            <p>
              <strong>Pelotica de Goma: The Legacy</strong> es el evento en vivo que celebra la cultura del béisbol
              venezolano, combinando nostalgia, competencia y entretenimiento en una experiencia híbrida para la
              audiencia.
            </p>
          </div>
        </section>
