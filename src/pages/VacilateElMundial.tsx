...
const VacilateElMundial = () => {
  ...
  const MEDIAKIT_URL = "/downloads/VacilateElFutbol-MediaKit-2026.pdf?v=20260805b";
      ...
      <Helmet>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "url": "https://www.vacilateesto.com/downloads/VacilateElFutbol-MediaKit-2026.pdf?v=20260805b",
            "inLanguage": "es-VE",
