...
2. `diarize.py` — corre pyannote/speaker-diarization-3.1 localmente, luego usa Gemini para mapear cada SPEAKER_XX a `juan`, `jhon`, `invitado` o `unknown`. Actualiza `speaker` y `speaker_confidence` en los chunks.
